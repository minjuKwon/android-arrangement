...
public final class NotesContract {
    ...
    public static final String JAVA_NOTES="java_notes";
    public static final String KOTLIN_NOTES="kotlin_notes";
    public static final Uri BASE_CONTENT_URI=Uri.parse("content://"+AUTHORITY);

    public static final class JavaNotesEntry implements BaseColumns {
        static final Uri CONTENT_URI=Uri.withAppendedPath(BASE_CONTENT_URI,JAVA_NOTES);
    ...
    public static final class KotlinNotesEntry implements BaseColumns{
        static final Uri CONTENT_URI=Uri.withAppendedPath(BASE_CONTENT_URI,KOTLIN_NOTES);
